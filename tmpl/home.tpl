...
<head>
	...
	<meta charset="utf-8">
	<title>Home / {$settings.site_name}</title>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/video.js/7.8.1/video.min.js"></script>
	...
	<!-- <script type="text/javascript" src="js/Version3/jquery.min.js"></script> -->
	<!-- <script src="js/Version3/bootstrap.min.js"></script> -->
	<!-- <script src="img/owl.carousel.min.js"></script> -->
					...
					<div class="row">
						<div class="col-md-12">
							<div class="topline header__topline">
								...
								<div class="topline__controls">
									<div class="header__login">{if $userinfo.logged != 1} <a href="?a=login"
										...
										<a href="?a=account" class="btn btn-warning" data-pjax>
											<img src="styles/assets/img/user.png">&nbsp; User's area</a>{/if}</div>
						...
						<div class="col-md-8 col-lg-6 class-res-ma" style="margin: 500px 0 0 0;">
							<div class="header__content">
								...
								<p class="header__text">{$settings.site_name} is an innovative company engaged
									<br>in investments in Cryptocurrencies and provide the stable income of 15% weekly -
									50% weekly.
								</p>{if $userinfo.logged != 1} <a href="?a=signup" class="btn btn-warning header__btn"
									data-pjax>
									Register
								</a>
								{else} <a href="?a=deposit" class="btn btn-warning header__btn" data-pjax>
									Investment
								</a>
								{/if}
...
<div class="powr-video-slider" id="44fc993b_1603724717"></div><script src="https://www.powr.io/powr.js?platform=html"></script>
					...
					<div class="row">
						<div class="col-md-6 col-lg-7">
							...
							<p class="section__text">
								{$settings.site_name} is a phenomenal crypto currency exchange and investment company. Our team
								...
								you can take advantage in one of the world's best trading programs. {$settings.site_name} mine,
						...
						<div class="col-sm-4  wow fadeInUp" data-wow-duration="1s" data-wow-delay="0s" cellspacing="0"
							...
							<div class="plans">
								<div class="plan_details text-center">
									...
									<div class="plans_btn">{if $userinfo.logged != 1} <a class="btn btn-warning"
							...
							<div class="plans cyne">
								<div class="plan_details text-center">
									...
									<ul class="list-items">
										...
										<li class="list-item">Instant Withdrawal</li>
										<li class="list-item">1-5% Affiliate Bonus</li>
									</ul>{if $userinfo.logged != 1} <a class="btn btn-warning" href="?a=login">Deposit
										Now</a>
									{else} <a class="btn btn-warning" href="?a=deposit">Deposit Now</a>
									{/if}
								</div>
					...
					<section class="section section-affilate textsite titlesite">
						<div class="container">
							<div class="row">
								...
								<div class="col-md-6">
									<p class="section__text">At {$settings.site_name}, we believe that advertising about
										our services by our satisfied clients is the best way to grow business. Keeping
										this in mind, {$settings.site_name} founded an amazing lucrative reward in terms
										of two level affiliate program.</p>
									<br>
									<p class="section__text">{$settings.site_name} is paying for the popularization of
						...
						<div class="container">
							<div class="row">
								<div class="col-md-12 section__title">
									...
									<h3 class="section__h3">
										At every step, the {$settings.site_name} provides
												...
												<div class="step howitwork__step">
													...
													<div class="step__body">
														...
														<div class="step__content">Open a free account with
															{$settings.site_name} by simply clicking on "Register".
															Complete the form and click submit.
															<br>Your account with {$settings.site_name} will be active.
														</div>
													</div>
												</div>
											</div>
							...
							<div class="row">
								...
								<div class="col-sm-6 col-md-3 mb-3 mb-md-0">
									<div class="statitem">
										...
										<div class="statitem__value gold">{$settings.site_days_online_generated}</div>
									</div>
								</div>
								<div class="col-sm-6 col-md-3 mb-3 mb-md-0">
									<div class="statitem">
								...
								<div class="col-sm-6 col-md-3 mb-3 mb-sm-0">
									<div class="statitem">
										...
										<div class="statitem__value gold">{$currency_sign}
											504,827.00</div>
									</div>
								</div>
								<div class="col-sm-6 col-md-3 mb-3 mb-sm-0">
